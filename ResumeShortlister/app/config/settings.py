...
class ProductionConfig(BaseConfig):
    DEBUG = False
    TESTING = False
    # Accept both canonical and accidental lowercase keys from .env
    ...
    if not SECRET_KEY:
        raise ValueError("No SECRET_KEY set for production environment (set SECRET_KEY in environment or .env)")
